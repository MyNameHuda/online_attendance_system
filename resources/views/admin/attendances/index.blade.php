...
<div class="space-y-4">
    <div class="flex items-center justify-between flex-wrap gap-2">
        <div>
            <h1 class="text-2xl font-bold text-slate-900">Daftar Absensi</h1>
            <p class="text-sm text-slate-500 mt-0.5">Monitor kehadiran karyawan. Klik baris untuk lihat foto & lokasi detail.</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
        <div class="bg-white rounded-2xl shadow-card border border-slate-200 p-4">
            ...
            <div class="text-xs text-slate-500 font-medium mt-0.5">Total Record</div>
        </div>
    ...
    <div class="bg-white rounded-2xl shadow-card border border-slate-200 p-4">
        <form method="GET" class="grid grid-cols-1 md:grid-cols-5 gap-3 text-sm">
            ...
            <div class="md:col-span-5 flex gap-2">
                ...
                <a href="{{ route('admin.attendances.index') }}" class="px-4 py-2 rounded-lg border border-slate-300 text-slate-700 hover:bg-slate-50 text-sm font-medium">Reset</a>
            </div>
        </form>
    </div>
                ...
                <table class="w-full text-sm">
                    <thead class="text-left text-xs text-slate-500 uppercase tracking-wider border-b border-slate-200 bg-slate-50/50">
                        <tr>
                            ...
                            <th class="py-3 px-3 font-semibold">Karyawan</th>
                        ...
                        @foreach($attendances as $a)
                            ...
                            <tr class="hover:bg-slate-50 transition">
                                ...
                                <td class="py-3 px-4 text-right">
                                    <a href="{{ route('admin.attendances.show', $a) }}" class="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg bg-brand-50 hover:bg-brand-100 text-brand-700 text-xs font-semibold">
                                        Detail
