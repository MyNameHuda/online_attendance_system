                ...
                <div class="flex items-center gap-8">
                    ...
                    <div class="hidden md:flex gap-1 text-sm font-medium">
                        ...
                        @if(auth()->user()->isKadiv())
                            <a href="{{ route('kadiv.attendances.index') }}" class="px-3 py-2 rounded-lg flex items-center gap-1.5 text-slate-600 hover:text-slate-900 hover:bg-slate-100 {{ request()->routeIs('kadiv.*') ? '!text-brand-700 !bg-brand-50' : '' }}">
